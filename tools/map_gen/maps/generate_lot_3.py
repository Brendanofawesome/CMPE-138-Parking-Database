...
fill(lot, 1, 7, 0, 0, square_type.Spot_Down, special_spots.Regular)
fill(lot, 8, 13, 0, 0, square_type.Spot_Down, special_spots.Handicap)

fill(lot, 1, 13, 9, 9, square_type.Spot_Up, special_spots.Regular)

fill(lot, 0, 0, 2, 7, square_type.Spot_Right, special_spots.EV)
